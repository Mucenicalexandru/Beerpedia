...
function Glass(props) {
    ...
    let glassDescription = [
        "A relatively small glass that has a conical shape, narrow at the bottom and opening up a bit at the top, showing off a lager’s clear, sparkling straw-gold color and allowing for a fluffy head",
                            ...
                            <Card style={{ width: '18rem', margin: '20px', padding: '20px' }}>
                                <Image src={`images/${glass.id}.jpg`} />
                                    <Card.Body>
                                        ...
                                        <GlassDescription>
                                            <Card.Text>{glassDescription[index]}</Card.Text>
                                        </GlassDescription>
                                    </Card.Body>
                            </Card>
                    </Col>
